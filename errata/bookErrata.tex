...
There is an errant comma.
	...
	\item
Style consistence throughout the chapter. In some locations $I_\delta$ is an open interval, in others, a closed interval. The reader should be careful. A consistent usage should be established.
