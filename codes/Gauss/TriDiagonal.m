...
% Solution of a linear system of equations with a tridiagonal matrix.
%
...
%
% Input
%   a(1:n), b(1:n), c(1:n) : the coefficients of the system matrix
%   f(1:n) : the right hand side vector
%
% Output
%   x(1:n) : the solution to the linear system of equations, if no division by zero occurs
