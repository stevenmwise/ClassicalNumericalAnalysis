...
ylabel('$\omega_9(x)$','Interpreter','latex')
xlabel('$x$','Interpreter','latex');
title('The Nodal Polynomial $\omega_9$ with Equally Spaced Nodes','Interpreter','latex');

printstr = strcat('NodalPolynomial.pdf');
...
ylabel('$\Omega_9(x)$','Interpreter','latex')
xlabel('$x$','Interpreter','latex');
title('$\Omega_9(x) = \int_0^x\omega_9(t)\, \mbox{d} t$','Interpreter','latex');

printstr = strcat('IntNodalPolynomial.pdf');
exportgraphics(gca, printstr)
