...
axis([-1 1 -1 1])
exportgraphics(gca, 'RungePhenom.pdf')
...
axis([-1 1 -1 1])
exportgraphics(gca, 'RungePhenomFix.pdf')
...
lgd = legend('$\omega_9(x)$ (Chebyshev)', ...
  '$\omega_9(x)$ (Uniform)',...
  '$2^{-8}$','$-2^{-8}$')
lgd.FontSize = 14;
lgd.Interpreter = 'latex';
exportgraphics(gca, 'OmegaPlot.pdf')
