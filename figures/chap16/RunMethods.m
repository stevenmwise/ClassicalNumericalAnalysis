function [energyPSD, energyAGD, upsd, uagd] = RunMethods( E, Ep, mu, L, MaxIts, uinit )
% This function runs both the Steepest Descent with approximate line
% search (PSD)
%
...
%
% methods for a stongly convex and (locally) Lipschitz smooth objective E 
% with derivative Ep
%
% Input
...
%   L : (an estimate of) the (local) Lipschitz smoothness constant for E
%   MaxIts : the maximal number of iterations
%   uinit : an initial guess for the minimizer
%
% Output
%   energyPSD(1:MaxIts+1) : the value of the objective at every iteration 
%                           of PSD
%   energyAGD(1:MaxIts+1) : the value of the objective at every iteration
%                           of AGD
%   upsd : the approximate minimizer after MaxIts iterations of PSD
%   uagd : the approximate minimizer after MaxIts iterations of AGD
%
