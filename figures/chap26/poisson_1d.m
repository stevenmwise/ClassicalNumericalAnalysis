function [e_ps,e_fd] = poisson_1d(L,m,should_we_plot)
%
...
%
% using MATLAB Fast Fourier Transform algorithm.
%
%%%%%%%%%
% INPUT:
%
% L is the size of the domain and should be a positive number.
%
% m is the number of points in the periodic grid. Generally 
%   this should be a positive, even number.
%
% OUTPUT:
%
% e_ps is the max norm of the error in the pseudo-spectral 
%   computation.
%
% e_fd is the max norm of the error in the finite difference 
%   computation.
%
%%%%%%%%%
%
% h is the grid spacing and x holds the nodal values of the
%   grid.
h = L/m;
x = (1:m)*h;
%
...
%%%%%%%%%%%%
if should_we_plot == 1
  s = ["OUT/poisson", num2str(m), ".pdf"];
  print(hf,s,'-dpdflatex')      
  
  sGray = ["OUT/poisson", num2str(m), "Gray.pdf"];
  print(hf,sGray,'-dpdflatex', '-mono')      
